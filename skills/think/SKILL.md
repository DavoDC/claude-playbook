...
**Synergy:** /aristotle is the deconstruction engine. /prioritise is the ranking interface. /think is the build interface that chains both with the engineering algorithm.
